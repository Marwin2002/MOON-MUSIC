...
from MOON import YouTube, app
from MOON.core.call import PURVI
from MOON.misc import SUDOERS, db
from MOON.utils.database import (
    get_active_chats,
    get_lang,
    get_upvote_count,
    is_active_chat,
...
from MOON.utils.database import get_assistant
from MOON.utils.decorators.language import languageCB
from MOON.utils.formatters import seconds_to_min
from MOON.utils.inline import close_markup, stream_markup, stream_markup_timer
from MOON.utils.stream.autoclear import auto_clean
from MOON.utils.thumbnails import get_thumb
from config import (
    BANNED_USERS,
    SOUNCLOUD_IMG_URL,
    STREAM_IMG_URL,
